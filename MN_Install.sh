#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='VENTURE.conf'
CONFIGFOLDER='/root/.VENTURE'
COIN_DAEMON='ventured'
COIN_CLI='venture-cli'
COIN_PATH='/usr/local/bin/'
COIN_GETDMN='https://github.com/vencoin1/Vencoin/releases/download/1.0.0/ventured'
COIN_GETCLI='https://github.com/vencoin1/Vencoin/releases/download/1.0.0/venture-cli'
COIN_NAME='VENTURE'
COIN_EXPLORER='http://149.28.9.237'
COIN_PORT=32229
RPC_PORT=32230
